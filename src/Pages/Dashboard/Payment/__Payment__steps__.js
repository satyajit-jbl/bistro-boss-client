 ...
 * install stripe on the server side and get client secret. amke sure you userd the payment method types; ['card']
 * 6. from cliend side get the client secret and sace it
